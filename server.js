...
io.on('connection', socket => {
    socket.on('joinGame', (data) => {
        ...
        if (!autogenerated && containsBannedWord(name)) {
            const choices = ['Imbecile', 'Nitwit', 'Nimrod', 'Dimwit', 'Moron','Dullard','Fathead'];
